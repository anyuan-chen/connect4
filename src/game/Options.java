...
public class Options {
    ...
    public Options() {
        ...
        /**
         * Reason a method was not used for the repetitive code below is because
         * they are of different data types and all have specific checks in
         * them. (eg. one must add .png to the color name to access the file
         */
        ...
        saveAndExit.addActionListener(
                actionEvent -> {
                    ...
                    currentModerateDifficulty = Integer.parseInt(String.valueOf(ai2Difficulty.getSelectedItem())) + 2;
